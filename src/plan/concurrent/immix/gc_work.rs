    ...
    for ConcurrentImmixSTWGCWorkContext<VM, KIND>
{
    ...
    type DefaultProcessEdges = PlanProcessSlots<VM, ConcurrentImmix<VM>, KIND>;
    type PinningProcessEdges = PlanProcessSlots<VM, ConcurrentImmix<VM>, TRACE_KIND_TRANSITIVE_PIN>;
}
pub(super) struct ConcurrentImmixGCWorkContext<E: ProcessSlotsWork>(std::marker::PhantomData<E>);

impl<E: ProcessSlotsWork> crate::scheduler::GCWorkContext for ConcurrentImmixGCWorkContext<E> {
    type VM = E::VM;
