...
mod malloc_ms_work {
    ...
    use crate::policy::marksweepspace::metadata::is_chunk_marked_unsafe;
    ...
    impl<VM: VMBinding> GCWork<VM> for MSSweepChunks<VM> {
        ...
        fn do_work(&mut self, _worker: &mut GCWorker<VM>, mmtk: &'static MMTK<VM>) {
            ...
            let mut chunk =
                unsafe { Address::from_usize(ms.chunk_addr_min.load(Ordering::Relaxed)) }; // XXX: have to use AtomicUsize to represent an Address
