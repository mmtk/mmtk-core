...
impl<VM: VMBinding> crate::scheduler::GCWorkContext for MSGCWorkContext<VM> {
    ...
    type DefaultProcessEdges = PlanProcessSlots<Self::VM, MarkSweep<VM>, DEFAULT_TRACE>;
    type PinningProcessEdges = PlanProcessSlots<Self::VM, MarkSweep<VM>, DEFAULT_TRACE>;
}
