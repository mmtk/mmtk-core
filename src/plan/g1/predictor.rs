...
const INITIAL_NURSERY_RATIO: f32 = 0.2;
...
impl PauseTimePredictor {
    ...
    pub fn pause_start(&mut self, num_workers: usize, nursery_regions: usize) {
        // println!("Pause Start num_workers={}", num_workers);
    ...
    pub fn update_parameters(&mut self, pause_time: usize, gc_kind: GCKind) {
...
impl AccumulativePauseTimePredictor for G1AccumulativePredictor {
    fn record(&mut self, r: RegionRef) {
        ...
        self.total_s_c += (self.s * r.rs_size() as f32) as f32 + (self.c * r.live_size.load(Ordering::SeqCst) as f32) as f32;
    }
