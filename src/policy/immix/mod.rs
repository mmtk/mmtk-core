...
pub const PREFER_COPY_ON_NURSERY_GC: bool = !cfg!(feature = "immix_non_moving") || !cfg!(feature = "sticky_immix_non_moving_nursery"); // copy nursery objects if we are allowed to move.
