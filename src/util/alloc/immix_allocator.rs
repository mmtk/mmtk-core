...
impl<VM: VMBinding> Allocator<VM> for ImmixAllocator<VM> {
    ...
    fn alloc(&mut self, size: usize, align: usize, offset: isize) -> Address {
        ...
        debug_assert!(size <= crate::policy::immix::MAX_IMMIX_OBJECT_SIZE,
            "Trying to allocate a {} bytes object, which larger than MAX_IMMIX_OBJECT_SIZE {}", size, crate::policy::immix::MAX_IMMIX_OBJECT_SIZE);
