...
#[repr(C)]
pub struct MyAllocator<VM: VMBinding> {
...
impl<VM: VMBinding> MyAllocator<VM> {
...
impl<VM: VMBinding> Allocator<VM> for MyAllocator<VM> {
    ...
    fn alloc(&mut self, size: usize, align: usize, offset: isize) -> Address {
        ...
        if new_cursor > self.limit {
            ...
            trace!(
                "My allocation size: {}, result: {}, new_cursor: {}, limit: {}",
                size,
                result,
                self.cursor,
                self.limit
