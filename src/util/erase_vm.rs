//! MMTk uses [`crate::vm::VMBinding`] to call into a binding, which allows us to call into bindings
...
//!
//! This module defines a macro that can be used to create a special ref type that erases the <VM> type parameter.
