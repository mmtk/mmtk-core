...
options! {
    ...
    // Precise stress. Trigger stress GCs exactly at X bytes if this is true. This is usually used to test the GC correctness
    ...
    // But this has no obvious mutator overhead, and can be used to test GC performance along with a larger stress
