...
pub extern "C" fn alloc(
    mutator: *mut SelectedMutator<DummyVM>,
    size: usize,
    align: usize,
    offset: isize,
    allocator: Allocator,
...
pub extern "C" fn post_alloc(
    ...
    memory_manager::post_alloc::<DummyVM>(
        unsafe { &mut *mutator },
        refer,
        type_refer,
        bytes,
...
#[no_mangle]
pub extern "C" fn report_delayed_root_edge(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
    addr: Address,
) {
...
#[no_mangle]
pub extern "C" fn will_not_move_in_current_collection(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
    obj: ObjectReference,
) -> bool {
    memory_manager::will_not_move_in_current_collection(
        &SINGLETON,
        unsafe { &mut *trace_local },
        obj,
    )
}

#[no_mangle]
pub extern "C" fn process_interior_edge(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
    target: ObjectReference,
    slot: Address,
    root: bool,
) {
    memory_manager::process_interior_edge(
        &SINGLETON,
        unsafe { &mut *trace_local },
        target,
        slot,
...
#[no_mangle]
pub extern "C" fn trace_get_forwarded_referent(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
...
#[no_mangle]
pub extern "C" fn trace_get_forwarded_reference(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
    object: ObjectReference,
) -> ObjectReference {
...
#[no_mangle]
pub extern "C" fn trace_retain_referent(
    trace_local: *mut SelectedTraceLocal<DummyVM>,
    object: ObjectReference,
) -> ObjectReference {
