...
pub fn issue139_alloc_non_multiple_of_min_alignment() {
    with_mockvm(
        ...
        || {
            ...
            let addr = memory_manager::alloc(&mut fixture.mutator, 14, 8, 0, AllocationSemantics::Default);
            ...
            let addr2 = memory_manager::alloc(&mut fixture.mutator, 14, 8, 0, AllocationSemantics::Default);
