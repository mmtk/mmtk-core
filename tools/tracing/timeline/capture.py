...
""")
    ...
    parser.add_argument("--enable-sweep-chunk-ms", action="store_true",
                        help="enable the 'sweep_chunk_ms' probe." +
                        "  This USDT only exists when the 'eager_sweeping' feature is enabled (disabled by default).")
...
def main():
    ...
    if not args.enable_sweep_chunk_ms:
        delete_lines_between(scripts_lines, "BEGIN:SWEEP_CHUNK_MS", "END:SWEEP_CHUNK_MS")
